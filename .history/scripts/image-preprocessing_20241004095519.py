...
val_images_dir = os.environ.get("VAL_IMAGES_DIR")
train_annotations_file = os.environ.get("TRAIN_ANNOTATIONS_FILE")
valid_annotations_file = os.environ.get("VALID_ANNOTATIONS_FILE")
